...
public class ExampleBiFunction {
    ...
    //Aplicacion de acumuladores trabajan con la interfaz BiFunction en streams por ejemplo sumar los elementos de una lista
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Resultado l1 y l2" + result);
    }
